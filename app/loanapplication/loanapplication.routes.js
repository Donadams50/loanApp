module.exports = app => {
    ...
    const { verifyToken, isAdmin , isApproval, isLoanOfficer} = jwtTokenUtils;
     ...
     app.get("/graph/report/loanofficer", verifyToken, isLoanOfficer,   loanApplication.reportLoanOfficer)
     app.get("/graph/report/approval", verifyToken, isApproval,   loanApplication.reportLoanOfficer)
}
